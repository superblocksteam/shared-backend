...
export abstract class DatabasePluginPooled<Conn, DatasourceConfig> extends DatabasePlugin {
   ...
   */
  protected abstract executePooled(executionProps: PluginExecutionProps<DatasourceConfig>, conn: Conn): Promise<ExecutionOutput>;
  ...
  async execute(executionProps: PluginExecutionProps): Promise<ExecutionOutput> {
